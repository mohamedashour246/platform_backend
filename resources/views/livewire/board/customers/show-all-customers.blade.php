		...
		<div class="col-md-12">
			...
			<div class="row">
				<div class="col-md-12 mb-3">
					<a  href="{{ route('customers.create') }}" class="btn btn-primary float-right ml-1" > <i class="icon-plus3  mr-1"></i>@lang('customers.add_new_customer') </a>
					...
					<tbody>
						...
						<tr>
							...
							<td >
								...
								@lang('customers.city') {{ optional($customer->city)['name_'.$lang] }}
						...
						<tr class="collapse " id="collapse-icon{{ $customer->id }}" >
							<td colspan="100%" >
								<div class="float-left">
									<a target="_blank" href="{{ route('customers.show'  , ['customer' => $customer->id ] ) }}" class="btn btn-outline bg-primary border-primary text-primary-800 btn-icon">
										<i class="icon-eye2 text-primary-800"></i>
									</a>
									<a target="_blank" href="{{ route('customers.edit' , ['customer' => $customer->id ] ) }}" class="btn alpha-warning border-warning text-warning-800 btn-icon ml-2">
