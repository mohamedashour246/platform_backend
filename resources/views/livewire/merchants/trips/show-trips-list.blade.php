					...
					<div class="row">
						...
						<div class="col-md-2">
							...
							<select wire:model="status" class="form-control " >
								...
								<option value="0"> @lang('trips.trip_ongoing') </option>
								<option value="1"> @lang('trips.trip_proccessing') </option>
								<option value="2"> @lang('trips.trip_cancelld') </option>
								<option value="3"> @lang('trips.trip_deliverd') </option>
							</select>
						</div>
						<div class="col-md-3">
