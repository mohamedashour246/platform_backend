        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="header-elements d-none py-0 mb-3 mb-md-0">
                <div class="breadcrumb">
                    ...
                    <a href="{{ route('orders.index') }}" class="breadcrumb-item"><i class="icon-users4 mr-2"></i>  @lang('merchantDashbaord.edit_order') </a>
                    <span class="breadcrumb-item active"> @lang('merchantDashbaord.edit_order') </span>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <fieldset>
                           ...
                           <div class="row">
                               ...
                               <!-- Name En Field -->
                               <div class="form-group col-sm-6">
                                   {!! Form::label('time_to_arrive',  __('merchantDashbaord.time_to_arrive')) !!}
                                   {!! Form::time('time_to_arrive', null, ['class' => 'form-control']) !!}
                                   @error('time_to_arrive')
                                   <label class="text-danger font-weight-bold " > {{ $message }} </label>
                                   @enderror
                               </div>
                               ...
                               <div class="form-group col-sm-4">
                                   {!! Form::label('payment_type', __('merchantDashbaord.pay_type'))!!}
                               ...
                               <div class="form-group col-sm-4">
                                   <div class="form-check form-check-switchery mt-4">
                                       <label class="form-check-label">
                                           ...
                                           <input type="checkbox" name="status" class="form-check-input-switchery" {{$order->status == '1' ? 'checked' : ''}}>
                                       </label>
                                   </div>
                               </div>
                               <div class="form-group col-sm-4">
                                   {!! Form::label('total', __('merchantDashbaord.total_price')) !!}
