                        ...
                        <fieldset>
                           ...
                           <div class="row">
                               ...
                               <div class="form-group col-sm-6">
                                   ...
                                   <input type="file" name="image" id="input-file-max-fs" class="dropify image" data-default-file="{{asset('uploads/admins/'.$disslider->image)}}" data-max-file-size="2M" />
                               ...
                               <div class="form-group col-sm-4">
                                   <img src="{{asset('uploads/admins/'.$disslider->image)}}" style="width: 100px;"
