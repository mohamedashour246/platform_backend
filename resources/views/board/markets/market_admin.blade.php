	...
	<div class="col-md-2">
		...
		<div class="card">
			<div class="list-group list-group-flush ">
				...
				<a href="{{ route('market.admin'  , ['market' => $market->id ] ) }}" class="list-group-item list-group-item-action active text-white ">
	...
	<div class="col-md-10">
		...
		<div class="card">
			<div class="card-header bg-dark header-elements-inline">
				<h5 class="card-title"> @lang('markets.market_admin') {{ $market->name }} </h5>
				<div class="header-elements">
			...
			<div class="card-body">
				<table class="table  table-xs border-top-0 my-2">
					<tbody>
						<tr>
							<th class="font-weight-bold text-dark">@lang('markets.admin_name')</th>
							<td class="text-left"> {{ optional($market->marketAdmin)->name }} </td>
						</tr>
						<tr>
							<th class="font-weight-bold text-dark"> @lang('markets.phone') </th>
							<td class="text-left">	{{  optional($market->marketAdmin)->phone }}	</td>
						</tr>
						<tr>
							<th class="font-weight-bold text-dark"> @lang('markets.email') </th>
							<td class="text-left">	{{  optional($market->marketAdmin)->email }}	</td>
						</tr>
						<tr>
							<th class="font-weight-bold text-dark"> @lang('markets.notes') </th>
							<td class="text-left">	{{  optional($market->marketAdmin)->notes }}	</td>
						</tr>
						<tr>
							<th class="font-weight-bold text-dark"> @lang('markets.activation') </th>
							<td class="text-left">	
								@switch(optional($market->marketAdmin)->active)
								@case(1)
