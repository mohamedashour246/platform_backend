	...
	<div class="page-header-content header-elements-md-inline">
		...
		<div class="header-elements d-none py-0 mb-3 mb-md-0">
			<div class="breadcrumb">
				...
				<span class="breadcrumb-item active"> @lang('governorates.add_new_governorate') </span>
			</div>
		</div>
	</div>
</div>
	...
	<div class="col-md-12">
		...
		<div class="card">
			<div class="card-header bg-dark header-elements-inline">
				<h5 class="card-title"> @lang('governorates.add_new_governorate') </h5>
			...
			<form action="{{ route('governorates.store') }}" method="POST"  enctype="multipart/form-data" >
				...
				<div class="card-footer bg-light" >
					<button type="submit" class="btn btn-primary float-right ml-2"> @lang('governorates.add') </button>
