	...
	<div class="page-header-content header-elements-md-inline">
		...
		<div class="header-elements d-none py-0 mb-3 mb-md-0">
			<div class="breadcrumb">
				...
				<span class="breadcrumb-item active"> @lang('drivers.add_new_driver') </span>
			</div>
		</div>
	</div>
</div>
	...
	<div class="col-md-12">
		...
		<div class="card">
			<div class="card-header bg-dark header-elements-inline">
				<h5 class="card-title"> @lang('drivers.add_new_driver') </h5>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-4">
									...
									<input type="text" name="driver_name" value="{{ old('driver_name') }}" class="form-control @error('name') is-invalid @enderror " >
									@error('name')
									<label class="text-danger font-weight-bold " > {{ $message }} </label>
									@enderror
								</div>
							...
							<div class="row">
								...
								<div class="col-md-4">
									...
									<div class="input-group ">
										...
										<input type="text" name="working_start_time" value="{{ old('working_start_time') }}" class="form-control @error('working_start_time')  is-invalid @enderror   pickatime">
									</div>
								...
								<div class="col-md-4">
									...
									<div class="input-group ">
										...
										<input type="text" name="working_end_time" value="{{ old('working_end_time') }}" class="form-control @error('working_end_time')  is-invalid @enderror  pickatime" >
									</div>
